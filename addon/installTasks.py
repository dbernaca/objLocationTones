...
def onInstall():
	...
	# Object Location Tones requires Windows 10 21H2 or later.
	...
	if currentWinVer < minimumWinVer:
		...
		raise RuntimeError("Attempting to install Object Location Tones on Windows releases earlier than 10")
